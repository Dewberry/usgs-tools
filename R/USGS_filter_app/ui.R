...
ui <- fluidPage(#theme="bootstrap.css",
  ...
  sidebarPanel(
    ...
    hidden(
      textInput(inputId ="site_no", 
                ...
                width = '400px',
                #value = "01615000",
                placeholder = "Format: 01615000")),
    
      hidden(textInput(inputId = "geocode",
                       label = "Search by Geographic Location",
                       width = '400px',
                       #value = "Fairfax, VA",
                       placeholder = "Format: Fairfax, VA")),
      
      hidden(textInput(inputId = "wgs84_coordinates_lat",
                       label = "Search by Coordinates: Latitude (WGS84)",
                       width = '350px',
                       #value = "38.86484",
                       placeholder = "Format: 38.86484"),
             textInput(inputId = "wgs84_coordinates_lon",
                       label = "Search by Coordinates: Longitude (WGS84)",
                       width = '350px',
                       #value = "-77.23508",
                       placeholder = "Format: -77.23508")),
  ...
  mainPanel(
    ...
    br(),
    div(align="right",
        tags$a(img(src="GitHub-Mark-32px.png", height="30", width="30"), href="https://github.com/Dewberry/usgs-tools/tree/master/R/USGS_filter_app"),
    ...
    tabsetPanel(type = "tabs",
                ...
                tabPanel("Summary", verbatimTextOutput("summary")), id = "tabs" ),
